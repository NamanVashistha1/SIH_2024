...
const Home = () => {
  ...
  const handleLanguageChange = (event) => {
    ...
    // Optionally: Add code here to handle the language change (e.g., update translations)
  };
    ...
    if (!responseFromAPI && inputPrompt.trim() !== "") {
      ...
      try {
        const response = await fetch("http://localhost:4000/respond", {
          ...
          body: JSON.stringify({ message: inputPrompt, language: selectedLanguage }),
        });
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', padding: '10px', marginTop: "10px"}}>
        <div
          id="botMessage"
            ...
            {chatLog.map((chat, idx) => (
              <div className="chatLog" key={chat.id} id={`chat-${chat.id}`}>
                ...
                <div className="botMessageWrapper">
                  ...
                  {/* { chat.botMessage = "HI! my name is kaustubh."} */}
                  {chat.botMessage === "Loading..." ? (
                    <Loading />
                  ) : err ? (
                    ...
                    <div id="botMessage">
                      {chat.botMessage}
                      {/* Add ReadAloud button here */}
                    </div>
                  )}
                  <ReadAloud text={chat.botMessage} />
        ...
        <form onSubmit={handleSubmit}>
          <div className="inputPromptWrapper">
            ...
            ></input>
            <VoiceRecognitionInput setInputPrompt={setInputPrompt} />
